...
class ClientScheduleUpdated
{
    ...
    public function __construct(private readonly Schedule $schedule)
    {
        $this->info = SaveLog::create(
            logName: ClientActivityLogsEnum::APP_CLIENTE_AGENDOU_CONSULTA->value,
            description: ClientActivityLogsEnum::APP_CLIENTE_AGENDOU_CONSULTA->description(),
            details: [
